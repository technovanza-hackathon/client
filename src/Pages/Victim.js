...
const Victim = () => {
  ...
  const onSubmit = async (data) => {
    ...
    alert(
      response.data.message + " Kindly Check Your Mail for Further Details"
    );
      ...
      <section id="appointment" className="appointment section-bg">
        <div className="container">
          <div className="section-title">
            <h2>Ask For Help</h2>
            <p>Please register your complaint here</p>
          </div>
            ...
            <div className="row">
              ...
              <div className="col-md-3 form-group mt-3 mt-md-0">
                <input
                  ...
                  data-rule="minlen:4"
                  data-msg="Please enter at a Valid Email"
                  {...register("email", {
                    required: true
                  })}
                />
              ...
              <div className="col-md-3 form-group mt-3 mt-md-0">
                <input
                  ...
                  type="text"
                  className="form-control"
                  name="disasterAddress"
                  id="address"
                  placeholder="Enter Your Address"
                  data-rule="address"
                  data-msg="Please enter a Valid Address"
                  {...register("disasterAddress", {
                    required: true
                  })}
                />
                <div className="validate"></div>
            ...
            <div className="row">
              ...
              <div className="col-md-4 form-group mt-3">
                <input
                  ...
                  data-rule="aadhar"
                  data-msg="Please enter a Valid Aadhar Number"
                  {...register("aadhar", {
                    required: true
                  })}
                />
